...
export const PRODUCTS: Record<string, ProductData> = {
  mounjaro: {
    ...
    whatIsDescription: "Mounjaro is a prescription medication formulated for weight loss and long-term weight management.",
    infoCards: [
      {
        title: "Active ingredient",
        content: "Mounjaro contains tirzepatide, which helps regulate your appetite and blood sugar levels."
      },
      {
        title: "How it works",
        content: "It makes you feel fuller sooner, reducing hunger and helping you eat less. It also lowers your blood sugar levels by improving your response to insulin."
      },
      {
      ...
      {
        title: "Suitability",
        content: "Mounjaro is suitable for adults with obesity (BMI over 30) or those overweight (BMI over 27) with certain weight-related health conditions."
      },
      {
        title: "Effectiveness",
        content: "Clinical studies have shown significant weight loss, with patients losing around 26% of their body weight in 84 weeks."
      },
      {
        title: "Side effects",
        content: "Possible side effects include nausea, diarrhoea, vomiting, constipation, abdominal pain, reduced appetite, and indigestion."
      }
    ],
    footerNote: "Mounjaro can help you to manage weight effectively and achieve significant weight loss alongside a diet and exercise programme.",
    videoSection: {
      title: "How to use your Mounjaro pen",
      description: "Watch our step-by-step video to see how your Mounjaro pen works.",
      videoUrl: "https://player.vimeo.com/video/975170018?title=0&byline=0&portrait=0&playsinline=0&autopause=0&app_id=122963"
    },
    buyingSection: {
      title: "How to buy Mounjaro in Northampton",
      description: "Looking to buy Mounjaro in Northampton? Here are the steps you need to follow.",
      steps: [
        {
          title: "Provider",
        ...
        {
          title: "Consultation",
          content: "Understand if Mounjaro is right for you via an online consultation with your chosen healthcare provider."
        },
        {
          title: "Prescription",
          content: "If Mounjaro is right for you, your healthcare provider will issue a prescription."
        },
        {
          title: "Pharmacy",
    ...
    dosageSteps: [
      {
        period: "Weeks 1–4",
        content: "Start with a dose of 2.5mg once a week. This initial dose is designed to help your body gradually adjust to the medication."
      },
      {
        period: "Weeks 5–8",
        content: "Increase the dose to 5mg, taken once weekly. This increase helps to enhance the medication's efficacy while monitoring your tolerance."
      },
      {
        period: "Weeks 9–12",
        content: "Increase the dose again to 7.5mg once weekly. This step depends on how well you've tolerated the previous doses."
      },
      {
        period: "Weeks 13-16",
        content: "Increase the dose to 10mg once weekly. This dose is part of the standard progression aiming for optimal weight loss."
      },
      {
        period: "Weeks 17+",
        content: "Depending on your doctor's advice and how well you've tolerated the 10mg dose, you may increase to a maximum of 15mg once weekly."
      }
    ],
    dosageFooterNote: "This structured dosing schedule helps to minimise side effects and allows your body to adapt to each new dose level gradually. Always follow your healthcare provider's instructions and discuss any concerns with them to ensure the best outcomes from your treatment plan. Not all patients will need to reach the highest dose. Your dose is tailored based on your response and how you tolerate the medication. It may be that you need to increase the dose more slowly than every 4 weeks, but you must not increase the dose more quickly than that.",
    references: [
      {
      ...
      },
      {
        ...
        description: "Mounjaro KwikPen 2.5mg solution for injection in pre-filled pen.",
        url: "https://www.medicines.org.uk/emc/product/15481/smpc#gref"
      },
      {
        title: "Eli Lilly",
        description: "Lilly's tirzepatide achieved up to 15.7% weight loss in adults with obesity or overweight and type 2 diabetes.",
      ...
      },
      {
        ...
        description: "Continued treatment with tirzepatide for maintenance of weight reduction in adults with obesity.",
      ...
      },
      {
        ...
        description: "Mounjaro helped people with obesity lose 26% of their body weight in 84 weeks.",
  ...
  wegovy: {
    ...
    whatIsDescription: "Wegovy is a prescription medication designed for weight loss and weight management. Here's an overview of what you should know about Wegovy.",
    infoCards: [
      {
        title: "Active ingredient",
        content: "Wegovy contains Semaglutide, the same active ingredient used in Ozempic, a medication used for type 2 diabetes."
      },
      {
        title: "How it works",
        content: "It mimics a hormone that regulates appetite, which makes you feel fuller, so you eat less."
      },
      {
        title: "Administration",
        content: "Wegovy is a once-weekly patient-administered injection, making it a convenient option for continuous weight management."
      },
      {
        title: "Suitability",
        content: "It's intended for adults with obesity (BMI over 30) or those overweight (BMI over 27) with weight-related conditions like hypertension or type 2 diabetes."
      },
      {
        title: "Effectiveness",
        content: "Clinical studies have shown up to 15% weight loss with Wegovy, making it a powerful tool to be used alongside diet and exercise."
      },
      {
        title: "Side effects",
        content: "Common side effects of Wegovy include nausea, diarrhoea, vomiting, constipation, stomach pain, headache, tiredness, upset stomach, dizziness, feeling bloated, belching, gas, stomach flu, and heartburn."
      }
    ],
    footerNote: "Only purchase Wegovy from reputable sources to avoid counterfeit medications and ensure you receive genuine, safe treatment.",
    dosageTitle: "Wegovy dosing schedule",
    dosageDescription: "Wegovy follows a gradual dose escalation schedule to minimize side effects while maximizing weight loss benefits.",
    dosageSteps: [
      {
        period: "Weeks 1–4",
        content: "Start with 0.25mg once weekly. This initial dose helps your body adjust to the medication."
      },
      {
        period: "Weeks 5–8",
        content: "Increase to 0.5mg once weekly. Monitor tolerance and effectiveness at this dose."
      },
      {
        period: "Weeks 9–12",
        content: "Increase to 1mg once weekly. Continue monitoring for side effects and weight loss progress."
      },
      {
        period: "Weeks 13–16",
        content: "Increase to 1.7mg once weekly. This is often an effective maintenance dose for many patients."
      },
      {
        period: "Weeks 17+",
        content: "May increase to maximum 2.4mg once weekly if needed and well-tolerated for optimal weight loss."
      }
    ],
    dosageFooterNote: "The gradual dose escalation helps minimize gastrointestinal side effects while achieving optimal weight loss. Your healthcare provider will determine the right dose progression based on your tolerance and response to treatment."
  },
  saxenda: {
    id: "saxenda",
    name: "Saxenda",
