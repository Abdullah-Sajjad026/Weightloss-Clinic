...
export function ExpertAdviceCTA({
  ...
  return (
    <div
      className={cn(
        "bg-gradient-to-br from-secondary-50 via-white to-secondary-100 ring-secondary-500/20 ring-1 ring-inset items-start text-left rounded-5xl w-full lg:p-10 flex flex-col justify-between gap-4 p-6 md:flex-row md:items-center relative overflow-hidden",
        className
      )}
    >
      <div>
