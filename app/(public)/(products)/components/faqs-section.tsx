...
export function FAQsSection({ 
  ...
  return (
    <div className={`${colors.background} ${colors.ring} bg-[url(https://ik.imagekit.io/medicspot/rays.webp?updatedAt=1746126061944)] bg-[length:100%_auto] bg-top bg-no-repeat bg-blend-overlay ring-1 ring-inset items-center text-center rounded-5xl flex w-full flex-col px-4 py-6 lg:p-10 overflow-hidden`}>
