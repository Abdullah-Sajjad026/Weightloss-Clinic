...
export default function AppointmentCTASection() {
  return (
    <section className="mx-auto px-4 max-w-7xl w-full">
      <div className="bg-primary-600 ring-primary-500/20 bg-[url(https://ik.imagekit.io/medicspot/rays.webp?updatedAt=1746126061944)] bg-[length:100%_auto] bg-top bg-no-repeat bg-blend-overlay ring-1 ring-inset items-center text-center rounded-5xl flex w-full flex-col px-4 py-12 lg:py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-lg text-primary-100 text-balance lg:text-xl">
            Join hundreds of people in Northampton who have already transformed their lives. Book your consultation today and take the first step towards achieving your weight loss goals.
          </p>
