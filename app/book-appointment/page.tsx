  ...
  const handleSubmit = async (data: AppointmentFormData) => {
    try {
      ...
      if (response.ok) {
        ...
        alert(error.error || 'Failed to submit appointment request')
      }
    } catch (error) {
            ...
            <CardContent className="p-8 text-center">
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-gray-600 max-w-md">
                  Thank you, {submittedData.name}! Your appointment request has been received. 
                  Our team will contact you at {submittedData.email} within 24 hours to confirm 
                  your consultation and provide video call details.
                </p>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 w-full max-w-md">
                  ...
                  <ul className="text-sm text-blue-800 space-y-1">
                    ...
                    <li>• You'll receive an email with video call instructions</li>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Book a convenient time to speak with our medical professionals about your weight loss journey. 
            All consultations are conducted via secure video calls.
          </p>
        </div>
